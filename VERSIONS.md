...
`inet-4.5.4-0a1d409733`. A separate timestamped capture of the actual Windows
host OS and C++ compiler remains an author-verification item before release.
...
Before publication, record the actual OS/compiler and INET commit used for the
reported manuscript results without changing these frozen required versions.
